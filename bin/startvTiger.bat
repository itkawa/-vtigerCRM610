...
echo off
set mysql_dir=C:\WebServers\home\vtigerCRM610\mysql
set mysql_username=root
set mysql_password=
set mysql_port=33307
set database_name=vtigercrm600
set mysql_bundled=true
set apache_dir=C:\WebServers\home\vtigerCRM610\apache
set apache_bin=C:\WebServers\home\vtigerCRM610\apache\bin
set apache_conf=C:\WebServers\home\vtigerCRM610\apache\conf
